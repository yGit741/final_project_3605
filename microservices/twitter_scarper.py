...
import os
def scrap_top_twitter_in_range(api_object, start_year=2011,end_year=2017):
    ...
    for tweeter in top_tweeters:
        try:
            ...
            for tweet in tweepy.Cursor(api.user_timeline, user_id=tweeter).items():
...
#     api = authenticator(os.path.join("..", "data", "auth.txt"))
#     # print(scrap_top_twitter_in_range(api, 2011, 2017))
#     print(scrap_top_twitter_in_range(api, 2011, 2017))
